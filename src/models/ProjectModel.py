...
class ProjectModel(BaseDataModel):
    def __init__(self, db_client):
        ...
        self.collection = self.db_client[DataBaseEnum.PROJECT_COLLECTION_NAME.value] # create "prjects" collection 
    ...
    async def get_project_or_create_one(self, project_id: str):
        ...
        return Project(**document) # if there is a project convert it into Project object and return it
